...
parser.add_argument('output_filepath', type=str, help='path to a output .csv file')
parser.add_argument(
    '-r',
    '--radius',
    type=int,
    help=('radius for the fingerprints. ' 'Defaults to 2'),
    default=2,
)
parser.add_argument(
    '-b',
    '--bits',
    type=int,
    help=('number of bits composing the fingerprint. ' 'Defaults to 512'),
    default=512,
)
